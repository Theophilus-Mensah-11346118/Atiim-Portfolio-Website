...
import teamMemberImage from '../assets/dummyimg1.png'; // replace with the actual team member image path
    ...
    <div>
      ...
      <section>
        <section className='firsttext'>
          ...
          <div className='our'>
            <h2>Our Mission</h2>
            <p>Our mission is to empower businesses and individuals by providing cutting-edge 
            software development services that drive growth, efficiency, and success. We are committed to 
            excellence, innovation, and customer satisfaction, ensuring that every project we undertake meets 
            the highest standards.</p>
          </div>
          <div className='ceo'>
            <p>" We assist businesses in uncovering and meeting
            the demand for digital transformation by offering
            engineering and consulting services that enhance
            competitiveness and drive innovation."</p>
        ...
        <div className='meet'>
          ...
          <p>Our team is our greatest asset. Comprising talented developers, designers, project managers, and tech enthusiasts, 
          we collaborate closely to bring your vision to life. With diverse backgrounds and a shared passion for technology, 
          we continuously push the boundaries of what's possible.</p>
        </div>
        ...
        <div className="team-member">
            ...
            <p className='message'>Leading Atiim Technology Suite with a vision of innovation and excellence, Bismark is dedicated to driving the company's growth and success. With a profound commitment to delivering top-notch software solutions, he ensures that every project meets the highest standards of quality and efficiency.</p>
          </div>
        ...
        <ul className="never-do">
          <li>We Never abandon commitments</li>
          <li>We Never place theory over practice</li>
          <li>We Never take shortcuts at the expense of performance & efficiency</li>
          <li>We Never hide bad news</li>
        </ul>
